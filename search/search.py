...
def depthFirstSearch(problem: SearchProblem):
    ...
    while fringe.isEmpty() != True:
        ...
        if currentState[0] not in visitedStates:
            visitedStates.add(currentState[0])
            successors = problem.getSuccessors(currentState[0])
            for successor in successors:
                fringePush = (successor[0], currentState[1] + [successor[1]])
                fringe.push(fringePush)
    "*** YOUR CODE HERE ***"
...
def uniformCostSearch(problem: SearchProblem):
    ...
    while fringe.isEmpty() != True:
        ...
        if currentState[0] not in visitedStates:
            ...
            successors = problem.getSuccessors(currentState[0])
            for successor in successors:
                directions = currentState[1] + [successor[1]]
                cost = problem.getCostOfActions(directions)
                fringePush = (successor[0], directions)
                fringe.push(fringePush, cost)
    util.raiseNotDefined()
    ...
    while fringe.isEmpty() != True:
        ...
        if currentState[0] not in visitedStates:
            ...
            for successor in successors:
                ...
                fringePush = (successor[0], directions)
                fringe.push(fringePush, heuristicVal + cost)
    util.raiseNotDefined()
